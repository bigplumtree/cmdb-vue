<template>
  <div>
    <!-- 头部导航区 -->
    <el-page-header @back="goBack" content="Redis"></el-page-header>
    ...
    <!-- 进度条
      ...
      <el-tabs v-model="activeIndex" :before-leave="beforeTabLeave"  :stretch="true">
        ...
        <el-tab-pane label="参数" name="1">
          <el-form :model="softInstallParamters" :rules="softInstallFormRules" ref="installStartFormRef" label-width="180px">
            ...
            <el-row>
              <el-col :span="10">
                <el-form-item label="redis密码" prop="redis_password">
                  <el-input width="80px" placeholder="大小写字母,数字,字符最少包含两种,不少于9位" v-model="softInstallParamters.redis_password"></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="10">
                <el-form-item label="redis工作目录"  prop="redis_workpath">
                  <el-input width="80px" placeholder="例如: /data" v-model="softInstallParamters.redis_workpath"></el-input>
                </el-form-item>
              </el-col>
            </el-row>
            ...
            <el-row>
              <el-col :span="10">
                <el-form-item label="redis启动端口" prop="redis_port" >
                  <el-input width="80px" placeholder="例如:13303" v-model.number="softInstallParamters.redis_port"></el-input>
                </el-form-item>
              </el-col>
            </el-row>
      ...
      <el-col :span="6" >
        <el-card class="infoCard">
          ...
          <el-alert class="rightAlert" title="Redis其他配置项目前先不提供修改" type="info" :closable="false" show-icon></el-alert>
          <el-alert class="rightAlert" title="当前安装的版本是Redis-5.0.9,暂不提供其他版本" type="info" :closable="false" show-icon></el-alert>                
        </el-card>
      </el-col>
    </el-row> 
        ...
        this.$refs.installStartFormRef.validate((valid, obj) => {
          ...
          if (!valid) 
            ...
            let params = new URLSearchParams();
              ...
              params.append('redis_password', this.softInstallParamters.redis_password)
              params.append('redis_workpath', this.softInstallParamters.redis_workpath)
              params.append('redis_port', this.softInstallParamters.redis_port)
              this.$axios
                .post('deploy/redis/install/', params, {timeout: 0})
                .then(success => {
                  if(success.data.status === 200){
